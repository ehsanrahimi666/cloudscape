...
#
#    2. Test the connection first (30 seconds):
#         Rscript paper/run-real-analysis.R --mode test
#
#    3. If that works, run the pilot (about 15-30 minutes):
#         Rscript paper/run-real-analysis.R --mode pilot
#
#    4. If the pilot works, run the full analysis (about 2-5 hours):
#         Rscript paper/run-real-analysis.R --mode full
#
#    5. Send me the file it prints at the end:
#         paper/real-results/cloudscape-results-<date>.zip
#
...
OUT     <- getarg("out", "paper/real-results")
...
if (MODE == "test") {
  msg("Connection test passed. Now run:  Rscript %s --mode pilot",
      "paper/run-real-analysis.R")
